...
#     mat_path = os.path.join(path, "ultimate.mat")
    colormap = scipy.io.loadmat("/kaggle/input/dataset-1/colors.mat")["colors"]
...
if __name__ == "__main__":
    ...
    batch_size = 8  # Adjust this based on TPU memory constraints
    lr = 1e-4
    num_epochs = 50
    ...
    dataset_path = "/kaggle/input/dataset-1/ultra-pro-max-20240320T051651Z-001/ultra-pro-max/Prepared-data"
    # replace the dataset_path with your respective dataset
    model_path = os.path.join("/kaggle/working/files", "unetr_model_50.keras")
    csv_path = os.path.join("/kaggle/working/files", "Unetr_data_50.csv")
